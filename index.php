		...
		if($add){
			...
			if($confirm){
				...
				if(send_email($info)){
					...
					array_push($text,'Thanks for signing up. Please check your email for confirmation! Redirecting in 3 seconds..');
...
<form method="post" action="">
    ...
    <fieldset>
    			<input type="text" name="email" placeholder="Your Email" style="color:rgba(0,0,0,1.00);" />	
    		
    			<input type="submit" value="Submit" class="large blue button" name="signup" />			
    </fieldset>
